...
#creating 2-week and 4-week group    
  ...
  mutate(time_end_diff = time_end - dplyr::lag(time_end),
         group = ifelse(time_end_diff > 20, 1, 0)) %>% 
#reversing items
...
#creating means of explicit measures
  ...
  select(neptun_1, id, gender_1, age_1, iqms_avg, crms_avg, chms_avg, fms_avg, fsc_avg, crsc_avg, challengescenario_1, measurement, time_end)
```
