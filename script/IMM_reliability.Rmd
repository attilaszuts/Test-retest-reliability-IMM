...
library(readr); library(tidyverse); library(readxl); library(lubridate); library(ggplot2); library(stringr); library(vroom); library(janitor); library(widyr); library(data.table); library(ggpubr)
```
...
```{r}
final_diff2 <- 
  dplyr::setdiff(gnat_important2, final_gnat2[, -c(11,12)])
```
...
Correlation between criticism d score and explicit criticism measure
```{r}
ggscatter(final_data1, x = "crit_pos1", y = "crsc_avg1", 
          add = "reg.line", conf.int = TRUE,
          cor.coef = TRUE, cor.method = "spearman",
          xlab = "Criticism Positive D Score", ylab = "Criticism Scenario",
          add.params = list(color = "coral3",
                            fill = "gray27"))
ggscatter(final_data2, x = "crit_pos2", y = "crsc_avg2", 
          add = "reg.line", conf.int = TRUE,
          cor.coef = TRUE, cor.method = "spearman",
          xlab = "Criticism Positive D Score", ylab = "Criticism Scenario",
          add.params = list(color = "coral3",
